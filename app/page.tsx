...
export default function Home() {
  ...
  const allProjects: Project[] = [
    
    {
      ...
      category: ['web', 'ai'],
      technologies: ['JavaScript', 'AI Models', 'NLP'],
      featured: true
    },
    {
      id: 3,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <motion.p variants={itemVariants} className="text-lg text-foreground/80">
                A Backend engineer with 3+ years' experience building Java/Spring Boot and Node.js/Express microservices and designing scalable data stores (MongoDB, MySQL, PostgreSQL). Automated Docker‑Kubernetes CI/CD pipelines to cut release cycles by 25%, delivered real‑time processing and content‑review services that boosted performance by 40% and drove $100K+ in annual revenue !
              </motion.p>
