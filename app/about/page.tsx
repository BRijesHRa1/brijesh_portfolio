    ...
    <div className="min-h-screen rgb-bg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <p className="text-foreground/80 leading-relaxed">
                I'm a passionate software engineer with experience in full-stack development, specializing in 
                front-end technologies and automation. I focus on building high-performance, responsive web applications
      ...
      >
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="card-3d-content">
              <h3 className="text-2xl font-bold mb-4">Music Genre Classification using GTZAN</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="col-span-1 md:col-span-2">
                  <p className="text-foreground/80 mb-4">
                    Developed a music genre classification system using the GTZAN dataset, leveraging machine learning and deep learning 
                    models. The project demonstrated model comparison, feature representation analysis, and baseline evaluation.
                  </p>
                  <h4 className="text-lg font-semibold mb-2">Technologies Used:</h4>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {["Python", "scikit-learn", "TensorFlow/Keras", "KNN", "SVM", "Random Forest", "CNN", "Mel-spectrograms"].map((tech, index) => (
                  ...
                  <p className="text-foreground/80">
                    This system achieved the highest accuracy with CNNs by analyzing Mel-spectrograms. It has potential applications in 
                    personalized recommendations for platforms like Spotify and targeted commercial music selection.
                  </p>
                </div>
                <div className="col-span-1 bg-primary/5 rounded-lg p-4 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🎵</div>
                    <h4 className="text-lg font-semibold">Music Classification</h4>
                    <p className="text-sm text-foreground/70">Python & ML Implementation</p>
                  </div>
                </div>
              </div>
